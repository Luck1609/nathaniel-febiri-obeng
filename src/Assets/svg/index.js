...
export class CaretLeftOutline extends Component {
  render() {
    return (
      <svg width="8" {...this.props} height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export class CaretLeft extends Component {
  render() {
    return (
      <svg width="24" {...this.props} height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export class Logo extends Component {
  render() {
    return (
      <svg width="33" {...this.props} height="31" viewBox="0 0 33 31" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clipPath="url(#clip0_150_1422)">
          ...
          <path d="M32.0988 29.6014C32.1313 29.9985 31.8211 30.339 31.4268 30.339H1.59438C1.2009 30.339 0.890922 30.0002 0.922082 29.6037L3.06376 2.34718C3.09168 1.9927 3.38426 1.71973 3.73606 1.71973H29.1958C29.5468 1.71973 29.8391 1.99161 29.868 2.34499L32.0988 29.6014Z" fill="url(#paint0_linear_150_1422)" />
        ...
        <defs>
          <linearGradient id="paint0_linear_150_1422" x1="25.8733" y1="26.3337" x2="7.51325" y2="4.9008" gradientUnits="userSpaceOnUse">
...
export class Plus extends Component {
  render() {
    return (
      <svg {...this.props} viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
